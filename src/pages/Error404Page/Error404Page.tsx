...
const Error404Page = () => {
    ...
    return (
        <div className="w-full">
            <div className="bg-[#F6F7F8] w-full h-[calc(100%-42px)] flex flex-col items-center justify-center py-10 px-48">
                ...
                <p className="font-bold text-2xl mb-6">До перехода на главную страницу всего секунд:
