...
const HomeWelcomePage = () => {
    ...
    return (
        <div className="w-full">
            <div className="bg-[#F6F7F8] w-full h-[calc(100%-42px)] max-lg:h-full flex flex-col justify-center items-center px-4">
                ...
                <div className="mt-14 flex items-center justify-center max-sm:flex-col">
                    <p className="font-bold text-xl mt-3 mr-3">Не трать время впустую,</p>
